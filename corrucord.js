...
#realgrid .lamp figure::before, #realgrid .lamp figure::after {
    background-image: url(https://tdustries.pro/fs/img/things/lamp.gif) !important;
}
...
function updateEntityNames(){
		...
		env.entities.notsobozko.image = "https://tdustries.pro/fs/img/obesk/bozkobot/portrait.gif"
