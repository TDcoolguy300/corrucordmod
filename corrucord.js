...
.tozik .body::after {content: ""; background-image:url(/img/sprites/obesk/tozik/stage/tozik_arms.gif) !important;}
.tozik .head { background-image: url(/img/sprites/obesk/tozik/stage/tozik_eyes.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/stage/tozik_head.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/stage/tozik_headcore.gif) !important; }
...
.collapse #realgrid .truecreature .tozik .head {
    background-image: url(/img/sprites/obesk/tozik/stage/connector.gif), url(/img/sprites/obesk/tozik/stage/tozik_eyes.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/stage/tozik_head.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/stage/tozik_headcore.gif) !important;
}
...
body[quality="low"] #content .tozik {
    background-image: 
        ...
        url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/stage/tozik_head.gif),
        url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/stage/tozik_headcore.gif),
        url(/img/sprites/obesk/tozik/stage/tozik_arms.gif),
		url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/stage/tozikjacket.gif),
...
.vn-char#tozik .head { background-image: url(/img/sprites/obesk/tozik/full/tozik_eyes.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozik_head.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozik_headcore.gif)!important; }
.vn-char#tozik .body { background-image: url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozikjacket.gif), url(/img/sprites/obesk/tozik/full/tozik_body.gif)!important; }
.vn-char#tozik .body::before {
    background-image: url(url(/img/sprites/obesk/tozik/full/tozik_arms.gif)!important;
    background-size: inherit;
    content: "";
    animation: TINYHOVER 10s EASE-IN-OUT infinite alternate;
}
.vn-wrapper.vn-con #tozik .head { background-image: url(/img/sprites/obesk/tozik/full/connector.gif), url(/img/sprites/obesk/tozik/full/tozik_eyes.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozik_head.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozik_headcore.gif)!important; }
#content[embassyday="1"] .vn-char#tozik .head { background-image: url(/img/sprites/obesk/tozik/full/connectoralt.gif), url(/img/sprites/obesk/tozik/full/tozik_eyes.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozik_head.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozik_headcore.gif)!important; }

/* FOCUS */
.focus .head.tozik-focus {
    --rotation: rotateX(-90deg) rotateY(90deg);
    transform: translate(-100%, 0) var(--rotation);
    background-image: url(/img/sprites/obesk/tozik/full/tozik_eyes.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozik_head.gif), url(https://tdcoolguy300.github.io/corrucordmod/img/obesk/tozikdrip/full/tozik_headcore.gif)!important;
